from flask import Blueprint, request, Response, render_template, make_response, send_from_directory, current_app
...
def download_book():
    ...
    if not book_name:
        ...
        return send_from_directory(directory = current_app.config['BOOKS_DIR_SYSTEM'], filename = book_name, as_attachment=True, attachment_filename = book_name) #static/books